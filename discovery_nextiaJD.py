...
from util.data_loader import CSVDataLoader, NextiaJDCSVDataLoader
...
def aurum_search_and_eval(aurum_api: API, dataloader: CSVDataLoader, aurum_ds_name: str, output_dir: str, k: int) -> Tuple[float, float]:
    ...
    for query_id in tqdm(queries.keys()):
        query_table_name, query_column_name = query_id.split("!")
        # print("Query table name: ", query_table_name)
        # print("query column name: ", query_column_name)
        # exit()
        ...
        field = (aurum_ds_name, query_table_name, query_column_name)
        ...
        for i, res in enumerate(results):
            ...
            # print("Candidate table name: ", candidate_table_name)
            # print("Candidate column name: ", candidate_column_name)
